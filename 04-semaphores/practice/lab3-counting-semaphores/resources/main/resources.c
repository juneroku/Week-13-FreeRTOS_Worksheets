...
#define NUM_CONSUMERS 3   // (ยังไม่ได้ใช้ แต่อาจใช้ต่อยอดได้)
...
/* ===== Helpers: LED control for resource index ===== */
...
/* ===== app_main ===== */
void app_main(void) {
    ESP_LOGI(TAG, "Counting Semaphores Lab (EXP2: MAX_RESOURCES=5) Starting...");
    ...
    ESP_LOGI(TAG, "System operational — monitor logs for pool utilization.");
}